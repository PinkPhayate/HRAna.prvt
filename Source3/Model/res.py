...
class Rasult_Odds(object):
    def __init__(self, rid, nosql_connector):
        ...
        array = odds_dict['単勝']
        self.rval1[array[0]] = array[1]

        array = odds_dict['複勝']
        self._set_rval_dict(array)

        array = odds_dict['枠連']
        self.rval3[array[0]] = array[1]

        array = odds_dict['馬連']
        self.rval4[array[0]] = array[1]

        array = odds_dict['馬単']
        self.rval5[array[0]] = array[1]

        array = odds_dict['ワイド']
        self._set_rval_dict(array)

        array = odds_dict['三連複']
        self.rval7[array[0]] = array[1]

        array = odds_dict['三連単']
        self.rval8[array[0]] = array[1]
