 ...
 * @param string  _category_cd       カテゴリーコード
 */
function showCommentList( _show_id, _sort, _key, _repry_comment_url, _update_form_id, _max_length, _notify_title, _notify_url, _link_type, _link_url, _post_function, _report_url, _limit, _page, _like_comment_url, _category_cd )
{
 ...
 * @param string  _category_cd カテゴリーコード
 */
function showCommentListSimple( _show_id, _sort, _key, _link_url, _max_length, _limit, _category_cd )
{
 ...
 * @param string  _category_cd       カテゴリーコード
 */
function showComment( _show_id, _key, _comment_id, _repry_comment_url, _update_form_id, _max_length, _notify_title, _notify_url, _post_function, _report_url, _like_comment_url, _category_cd )
{
 ...
 * @param string  _category_cd  カテゴリーコード
 */
function postLikeComment( _key, _comment_id, _notify_title, _notify_url, _replace_word, _category_cd )
{
 ...
 * @param string  _category_cd  カテゴリーコード
 */
function postHiddenComment( _key, _comment_id, _replace_word, _category_cd )
{
 ...
 * @param string  _category_cd  カテゴリーコード
 */
function cancelHiddenComment( _key, _comment_id, _replace_word, _category_cd )
{
 ...
 * @param string  _category_cd    カテゴリーコード
 */
function showRealtimeCommentList( _show_id, _sort, _bbs_url, _notify_url, _link_type, _link_url, _max_length, _post_function, _subcategory_id, _limit, _page, _category_cd )
{
